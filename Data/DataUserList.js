  ...
  async  getUsers() {
    ...
    try {
      ...
      if (!querySnapshot.empty) {
        ...
        let dta =await this.getFormattedData(doc.data().registrationDate)
        let client = new PersonModel(doc.data().names, doc.data().lastName, doc.data().secondLastName, doc.data().email, doc.data().phone, doc.data().ci,  doc.data().gender,1);
